...
- refactor(rich): improve console markup handling and enhance panel content types

## [2026-08-07 23:44]

- feat(menu): update menu and console configuration
...
- feat(logging): add dual console logging to basicConfig
...
- refactor: update version to 0.11.20 with minor console/content fixes
