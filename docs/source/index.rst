.. ascii_colors documentation master file ...
...
For a full overview, installation instructions, and quick start examples, please see the
...
.. toctree::
   ...
   usage         # Keep detailed usage separate
   api
   contributing
   changelog
